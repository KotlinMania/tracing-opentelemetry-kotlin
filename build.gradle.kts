...
kotlin {
    ...
    val xcf = XCFramework("TracingOpentelemetry")

    macosArm64 {
        binaries.framework { baseName = "TracingOpentelemetry"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TracingOpentelemetry"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TracingOpentelemetry"
        flattenPackage = "io.github.kotlinmania.tracingopentelemetry"
    }

    android {
        namespace = "io.github.kotlinmania.tracingopentelemetry"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tracing-opentelemetry-kotlin", version.toString())

    pom {
        name.set("tracing-opentelemetry-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/tracing-opentelemetry - OpenTelemetry integration for tracing")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tracing-opentelemetry-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tracing-opentelemetry-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tracing-opentelemetry-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tracing-opentelemetry-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/tracingopentelemetry/codeql/_CodeqlEmptySource.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.tracingopentelemetry.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTracingOpentelemetryXCFramework",
    "assembleTracingOpentelemetryDebugXCFramework",
    "assembleTracingOpentelemetryReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseIosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugMacosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseMacosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugTvosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseTvosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugWatchosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseWatchosFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTracingOpentelemetryXCFramework",
