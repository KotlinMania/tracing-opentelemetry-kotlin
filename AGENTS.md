...
This file is the quick-reference operating contract for tracing-opentelemetry-kotlin. The longer
...
tracing-opentelemetry-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tracing-opentelemetry`](https://crates.io/crates/tracing-opentelemetry). Upstream Rust is the behavioral oracle while the
