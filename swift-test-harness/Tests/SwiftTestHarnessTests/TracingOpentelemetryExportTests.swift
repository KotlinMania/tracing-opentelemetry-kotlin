...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TracingOpentelemetry.swiftmodule/`
...
//      `import TracingOpentelemetry` above would fail at compile time.
//
//   2. The static archive `libTracingOpentelemetry.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TracingOpentelemetry" }` and
//      `flattenPackage = "io.github.kotlinmania.tracingopentelemetry"` configuration in
...
//      via the `TracingOpentelemetryLibrary` product.
//
